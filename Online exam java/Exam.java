...
{  
    ...
    {   
        ...
        //Arange option systmetically----------------
        Npanel.add(userLabel);     
        Npanel.add(textField1);  
        Npanel.add(passLabel);    
        Npanel.add(textField2);   
        Npanel.add(b1);          
...
{  
    ...
    {          
        ...
        {  
            JButton rev=new JButton("Review"+x);  
            rev.setBounds(480,20+30*x,100,35);  
            add(rev);  
